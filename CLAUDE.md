...
This project is indexed by GitNexus as **truck_blind_spot** (2113 symbols, 6750 relationships, 178 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
